...
public class JWebBrowser extends NSPanelComponent {
  ...
  //public static NativeWebBrowser JM_NativeWebBrowser; 
  ...
  public static INativeWebBrowserStatic webBrowserStatic = NativeCoreObjectFactory.create(INativeWebBrowserStatic.class, "chrriis.dj.nativeswing.swtimpl.components.core.NativeWebBrowserStatic", new Class<?>[0], new Object[0]);
